...
public class Test {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException { //flux de lecture
		// test1();
		...
		testDSerialiserArrayListPersonneXML();

	}

	static void testDSerialiserArrayListPersonneXML() throws IOException { 

		File f = new File("c:\\tmp\\test4arraylistjava.xml");
	...
	static void testSerialiserArrayListPersonneXML() throws IOException { // flux
																			// d'écriture
	...
	static void testDSerialiserXMLDeuxPersonne() throws IOException, ClassNotFoundException { // flux
																								// de
																								// lecture
	...
	static void testSerialiserDeuxPersonneXML() throws IOException { // flux
																		// d'écriture
	...
	static void testDSerialiserXMLPersonne() throws IOException, ClassNotFoundException { // flux
																							// de
																							// lecture
	...
	static void testSerialiserPersonneXML() throws IOException { // flux
																	// d'écriture
	...
	static void testDSerialiserBineairePersonne() throws IOException, ClassNotFoundException { // flux
																								// de
																								// lecture
	...
	static void testSerialiserPersonne() throws IOException { // flux d'écriture
