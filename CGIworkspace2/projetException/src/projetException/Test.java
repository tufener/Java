...
public class Test {
	...
	static void testmultDiv() {
		...
		} catch (ArithmeticException e) { // catch pour gérer les erreur
											// mathématique div par zéro
			System.out.println("mult par zéro");

		} catch (InputMismatchException e) { // catch pour gérer l'erreur de
												// saisie
			System.out.println("erreur de saisie");

		} catch (RuntimeException e) { // catch pour gérer l'erreur de saisie

			System.out.println("runtime par zéro");

		} catch (MultException e) { // catch pour gérer l'erreur de saisie

			System.out.println(e.toString());

		} catch (Exception e) { // catch pour gérer les erreurs générales
	...
	static void test4() { // gérer l'erreur avec le bloc try et catch
							// (encapsulation pour éviter le plantage !!)
		Scanner sc = new Scanner(System.in);
	...
	static void test3() { // out of band (tableau petit comparé notre demande)
		int[] tab = { 1, 5, 8 };
