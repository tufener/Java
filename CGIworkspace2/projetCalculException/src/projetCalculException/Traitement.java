...
public class Traitement {
	...
	public static String calcul(double op1, double op2, String operateur)
		...
		if (op1 < 0 || op2 < 0)
			throw new NegException("Valeur négative détectée", op1, op2);
		switch (operateur) {
		case "":
			throw new OpException("Opérateur pas renseigné", operateur);
		case "+":
		case "add":
		...
		default:
			throw new OpException("opérateur non connu", operateur);
