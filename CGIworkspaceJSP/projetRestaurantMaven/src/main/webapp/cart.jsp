			...
			<div class="col-md-12 ftco-animate">
				<div class="cart-list">
					<table class="table">
						...
						<tbody>
							<tr class="text-center" action="ServletArticles" method="post">
								...
								<td class="total"><input id="total"></td>
								<td class="btn btn-primary" href="#" role="button"
									onclick="somme()">Add</td>
								<script type="text/javascript">
									function somme() {
										var nbr1, nbr2, sum;
										nbr1 = Number(document
												.getElementById("quantity").value);
										nbr2 = Number(document
												.getElementById("nbr2").value);
										sum = nbr1 + nbr2;
							...
							<tr class="text-center">
								...
								<td class="btn btn-primary" href="#" role="button"
									action="d-flex total-price">Add</td>
							</tr>
							<!-- END TR-->
