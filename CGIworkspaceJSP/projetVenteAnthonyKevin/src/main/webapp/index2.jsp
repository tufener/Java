	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-left">
				<li><a href="#articles">Cartes Mère</a></li>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="nav-item dropdown"><a
					...
					aria-expanded="false"> </span> <c:out value="${client.prenom}" /></a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="ServletDeconnexion">Se déconnecter</a>
					</div></li>
				<li><a href="ServletPanier"><span
			...
			<div class="row">
				<c:forEach var="article" items="${applicationScope['listeArticle']}">
					<c:if test="${article.type == 1}">
						<div class="col-sm-4">
							<div class="card" style="width: 45rem; height: 60rem">
								<form action="ServletPanier" method="post">
									...
									<div class="card-body">
										...
										Quantité : <input type="number" min="1" max="9" value="1"
											id="qte" name="qte">
										<p style="color: green" ; width: 100px>
										...
										<button type="submit" class="btn btn-light"
											value="<c:out value="${article.id}"></c:out>">Ajouter</button>
								</form>
							</div>
						</div>
			</div>
