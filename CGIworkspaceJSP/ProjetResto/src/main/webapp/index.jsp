	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-lg-3 ftco-animate">
				...
				<form method="post" action="ServletAddPanier" id="product1">
					<div class="product">
			...
			<div class="col-md-6 col-lg-3 ftco-animate">
				<form method="post" action="ServletAddPanier" id="product2">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid"
			...
			<div class="col-md-6 col-lg-3 ftco-animate">
				<form method="post" action="ServletAddPanier" id="product3">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid"
			...
			<div class="col-md-6 col-lg-3 ftco-animate">
				<form method="post" action="ServletAddPanier" id="product4">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid"
			...
			<div class="col-md-6 col-lg-3 ftco-animate">
				<form method="post" action="ServletAddPanier" id="product5">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid"
						...
						<div class="text py-3 pb-4 px-3 text-center">
							...
							<input name="id" value="5" hidden>
							<div class="bottom-area d-flex px-3">
								<div class="m-auto d-flex">
									<a href="product-single.jsp"
										class="add-to-cart d-flex justify-content-center align-items-center text-center">
										<span><i class="ion-ios-menu"></i></span>
									</a> <a onclick="SubmitFruit5()"
										class="buy-now d-flex justify-content-center align-items-center mx-1"
										style="cursor: pointer;"> <span><i
											class="ion-ios-cart"></i></span>
									</a>
			...
			<div class="col-md-6 col-lg-3 ftco-animate">
				<form method="post" action="ServletAddPanier" id="product6">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid"
			...
			<script type="text/javascript">
				function SubmitFruit6() {
					document.getElementById("product6").submit();
				}
			</script>

			<div class="col-md-6 col-lg-3 ftco-animate">
				<form method="post" action="ServletAddPanier" id="product7">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid"
						...
						<div class="text py-3 pb-4 px-3 text-center">
							...
							<input name="id" value="7" hidden>
							<div class="bottom-area d-flex px-3">
								<div class="m-auto d-flex">
									<a href="product-single.jsp"
										class="add-to-cart d-flex justify-content-center align-items-center text-center">
										<span><i class="ion-ios-menu"></i></span>
									</a> <a onclick="SubmitFruit7()"
										class="buy-now d-flex justify-content-center align-items-center mx-1"
										style="cursor: pointer;"> <span><i
											class="ion-ios-cart"></i></span>
									</a>
			...
			<script type="text/javascript">
				function SubmitFruit7() {
					document.getElementById("product7").submit();
				}
			</script>


			<div class="col-md-6 col-lg-3 ftco-animate">
				<form method="post" action="ServletAddPanier" id="product8">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid"
			...
			<script type="text/javascript">
				function SubmitFruit8() {
					document.getElementById("product8").submit();
				}
			</script>
