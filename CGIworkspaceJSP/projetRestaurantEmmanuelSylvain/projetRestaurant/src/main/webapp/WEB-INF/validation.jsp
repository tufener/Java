...
<body class="drapeau">
	...
	Client c3 = (Client)session.getAttribute("client");
	String rep3 = c3.getPrenom() + " " + c3.getNom();
	rep3 += "<h3 style='color:green'><b> <br>Votre commande d'un montant de<br>";
	rep3 += prixT + " Euros<br>";
	rep3 += "à bien été prise en compte<br><br>A Bientôt</b></h3>";
	session.setAttribute("panier", new ArrayList<LignePanier>());
	out.print(rep3);
	%> 
	</div>
