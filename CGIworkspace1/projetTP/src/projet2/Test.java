...
public class Test {
	...
	static void tpinfo() {
		// on nomme déjà les claviers nécessaire un pour les String et l'autre
		// obligatoire pour les chiffres entiers, décimales ...
		...
		// Le mode console pour afficher et inscrire le prénom...
		System.out.println("prénom ???");
		String prénom = clavier.nextLine();
		...
		String s = "bienvenue " + nom + " " + "\t " + prénom + " " + datedenaissance + " " + sexe;
	...
	static void tpage() {
		...
		// "\t" pour laisser deux sauts de ligne entre les éléments
	...
	static void tpmenu() {
		...
		Scanner réponse = new Scanner(System.in); // variable réponse ou clavier
													// peu importe le nom
		int saisie = réponse.nextInt();
	...
	static void tpbouclev2() { // on fait conquéténation += afin de garder plus
	...
	static void testafficheTabstr(String[] x) { // on a donné dans les
												// paramètres
		// les
		// éléments concernant notre tableau
		// ce qui va nous permettre de
		// diminuer des lignes de codes dans
		// la méthode juste au-dessus
		for (String e : x)
