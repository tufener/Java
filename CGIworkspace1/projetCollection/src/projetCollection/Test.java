...
public class Test {
	...
	static void testHashMapv3() { // collection dynamique 3 (HashMap)
		Scanner sc = new Scanner(System.in);
		HashMap<String, String> hm = new HashMap<String, String>();
		String str = "marie"; //avec cette variable il occupe deux places différentes dans la mémoire mais ca marche !!
	...
	static void test4() { // collection dynamique 1 (ArrayList)
		...
		al1.add(new Personne("Jean", "salomé"));
	...
	static void test2() {
		ArrayList<Personne> al1 = new ArrayList<Personne>(100); // capacité
																// initiale de
																// 100 mais
																// attention si
																// on dépasse
