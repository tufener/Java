...
public class Test {
	...
	static void test8() {
		...
		Vehicule[] tab = { new Velo("Ciraptor", 550), new Voiture("K2000", 40000),
				new Bateau("Caravelle", 2000, EBateau.grand) };
		for (Vehicule v : tab) {
			System.out
					.println(v.avancer()); /*
											 * // methode avancer est polymorphe // car elle change selon le // vehicule
											 * // Le polymorphisme offre aux objets la possibilité d ’appartenir à //
											 * plusieurs catégories // à la fois (velo, voiture, vehicule, bateau)
											 */
			System.out.println(v.demarrer());
		}
	}
...
//			v3 = (Voiture)v2;
	...
	static void test4() {
		...
		Object vehicule2 = new Voiture("DESZ", 5);
