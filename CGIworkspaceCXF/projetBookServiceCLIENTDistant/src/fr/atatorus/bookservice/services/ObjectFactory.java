...
public class ObjectFactory {
    ...
    private final static QName _Hello_QNAME = new QName("http://services.bookservice.atatorus.fr/", "hello");
    private final static QName _HelloResponse_QNAME = new QName("http://services.bookservice.atatorus.fr/", "helloResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.bookservice.atatorus.fr/", name = "hello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.bookservice.atatorus.fr/", name = "helloResponse")
