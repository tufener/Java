 ...
 * 2020-02-19T11:56:22.887+01:00
 * Generated source version: 3.2.12
 *
 */
@WebServiceClient(name = "HelloService",
                  wsdlLocation = "http://localhost:8080/bookservice/services/hello?wsdl",
...
public class HelloService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/bookservice/services/hello?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/bookservice/services/hello?wsdl");
        }
        WSDL_LOCATION = url;
    }
