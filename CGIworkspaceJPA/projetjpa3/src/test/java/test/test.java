...
//		System.out.println(p.getNom());
//		System.out.println(p.getId());
		//System.out.println(p.getPc().getSerialNumber()); //on aura le Serial Number mais pas le reste car serial number c'est la clé étrangere de computer qui est sa clé primaire
